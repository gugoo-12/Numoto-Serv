    ...
    return (
        <>
            <div className='mt-10'>
                ...
                <div className=' rounded border w-full border-gray-200 p-3 grid grid-cols-[30%_25%_20%_10%_5%] gap-7 mt-6'>
                    {/* //one */}
                    ...
                    <div className=' w-full relative'>
                        ...
                        <label className="text-sm text-gray-700 font-medium ">Equipment</label>
