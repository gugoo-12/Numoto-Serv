  ...
  return (
    <div className="text-gray-700 font-[Inter] transition-all duration-300 ease-in-out">
      ...
      <div className="flex items-center justify-between mb-3">
        <Breadcrumb name={'Team'} ishidden={false} secName={''} />
          ...
          {user.map((client, index) => (
            ...
            >
              ...
              <div className="flex justify-between items-start mb-2.5">
                <div className="flex items-center space-x-2">
                  <div className="w-20 h-20 rounded-2xl bg-gradient-to-r from-gray-300 to-gray-200 flex items-center justify-center font-semibold text-gray-700 text-sm">
                    {client.avatar}
                  </div>
                  <div>
                    <h3 className="font-medium text-gray-800 text-lg">{client.name}</h3>
                    <p className="text-[12px] text-gray-500">Technician</p>
                  </div>
                </div>
              ...
              <div className="bg-green-50 p-2 rounded-md space-y-1.5 text-xs text-gray-700">
                ...
                <div className=" items-center mt-5">
                  <span className=' font-semibold mt-4'>Skills:</span>
                  <br />
                  <span className=' bg-gray-100 px-1 py-0.5'>
                    Inspection
                  </span>
                </div>
              </div>
