...
import Qthi from '../Quatation inputs/Qthi'
import Qfour from '../Quatation inputs/Qfour'
    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-between mb-1">
                <Breadcrumb name={'Quotation'} ishidden={''} secName={'Create'}/>
                    ...
                    <div className="max-w-full px-8 py-5 bg-white shadow-lg rounded-xl ">
                        ...
                        <div className='mt-4 grid grid-cols-[30%_4%_32%_4%_30%]'>
                            ...
                            <div className=' mt-4 w-full relative'>
                                ...
                                <label className="text-sm text-gray-700 font-medium ">Validity</label>
                            ...
                            <div className=' mt-4 w-full relative'>
                                ...
                                <label className="text-sm text-gray-700 font-medium ">Delivery Terms</label>
                        ...
                        <div className=' mt-4 grid grid-cols-[30%_4%_45%]'>
                            <div className='w-full relative'>
                                ...
                                <button
                                    type="button"
                                    className="flex absolute px-1 py-1 bottom-23 right-0 text-xs items-center justify-center bg-red-700 text-white rounded-md hover:bg-red-700"
                                >
                                    <i class="fa-solid fa-plus"></i>
                                </button>
                            </div>
                            <div></div>
                            <div className=' w-full'>
                                <label htmlFor='tbox' className="text-sm text-gray-700 font-medium ">Special Notes</label>
                                <div className=' mt-2'>
                                    <textarea
